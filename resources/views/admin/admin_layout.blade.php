  ...
  <body>
    ...
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        <a href="/dashboard" class="sl-menu-link @yield('dashboard')">
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{route('product')}}" class="nav-link @yield('all-product')">All Product</a></li>
          <li class="nav-item"><a href="{{route('product.create')}}" class="nav-link @yield('add-product')">Add Product</a></li>
        </ul>
